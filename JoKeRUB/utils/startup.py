    ...
    try:
        if BOTLOG:
            Config.CATUBLOGO = await l313l.tgbot.send_file(
                BOTLOG_CHATID,
                "https://t.me/katyamusic1/23",
                caption="**‏᯽︙ بــوت كاتيا يـعـمـل بـنـجـاح ✓ \n᯽︙ أرسل `.الاوامر`لرؤية اوامر السورس \n  ᯽︙ لأستعمال بوت الأختراق عبر كود التيرمكس أرسل`.هاك`**",
                buttons=[(Button.url("سورس كاتيا", "https://t.me/Source_Katya"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def add_bot_to_logger_group(chat_id):
    ...
    try:
        ...
        try:
            ...
            LOGS.error(str(e))
#by @Source_Katya بس اشوفك خامطه للكود اهينك وافضحك
JoKeRUB = {"@Source_Katya", "@miika3"}
async def saves():
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        botlog_group_id = await aljoker_the_best(l313l, "مجموعة أشعارات كاتيا")
        if botlog_group_id:
