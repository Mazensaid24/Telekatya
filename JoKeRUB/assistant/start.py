#    جميع الحقوق لمطوري سورس كاتيا حصريا لهم فقط
    ...
    if event.sender_id == bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                                     ...
                                     [Button.url("المطـور 🔗", "https://t.me/Ve_G4"), Button.inline(
        ...
        await tgbot.send_message(
            ...
            link_preview=False,
            buttons=[
                [custom.Button.inline("تنـصيب كاتيا  🐍", data="deploy")],
                [Button.url("تحتاج مسـاعدة ❓", "https://t.me/Ve_G4")],
            ],
        )
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                ...
                [Button.url("كروب المساعدة ❓", "https://t.me/miika3")],
            ],
        )
...
async def settings(event):
    if event.sender_id == bot.uid:
        ...
        await event.answer("انت لا تستطيع استخدام البوت احصل على بوتك من @Source_Katya", alert=True)




@tgbot.on(events.callbackquery.CallbackQuery(data=re.compile(b"rozname"))) 
async def settings(event):  #    قـسـم  الزغرفـة كاتيا
    if event.sender_id == bot.uid:
        await event.delete()
        await tgbot.send_message(event.chat_id,
