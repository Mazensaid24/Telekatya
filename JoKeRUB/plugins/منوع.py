...
R = [
    ...
    "**-** مطور السورس **⪼ [𓂄𓆩νιρ ʍαzεπ𓆪‌‌‏𓂁 ](t.me/Ve_G4)   \n"
    "**-** قناة السورس **⪼ [𐇮 𝗞𝗮𝗧𝘆𝗔 ](t.me/Source_Katya)   "
]
...
Devmazen = [5951674553]
#تضل تخمط من عمك مازن ؟ الى اين يستمُر الفشل ياغُلام
...
async def Hussein(event):
    ...
    await event.edit(f'**ها هيَ الفيزات تم استخراجها من قبل سورس كاتيا** \n@Source_Katya:\n {response.text}')
...
async def Hussein(event):
    ...
    async for edited_response in event.client.iter_messages(bot_username, limit=1):
        if edited_response.id == response.id and edited_response.message != response.message:
            response = edited_response
    await event.edit(f'**ها هيَ المعلومات للفيزا تم استخراجها من قبل سورس كاتيا** \n@Source_Katya\n {response.text}')
...
async def Hussein(event):
    ...
    async for edited_response in event.client.iter_messages(bot_username, limit=1):
        if edited_response.id == response.id and edited_response.message != response.message:
            response = edited_response
    await event.edit(f'**ها هيَ البطاقة تم فحصها من قبل سورس كاتيا** \n@Source_Katya\n {response.text}')
